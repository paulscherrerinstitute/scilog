...
const routes: Routes = [
  ...
  { path: 'logbooks/:logbookId', component: LogbookComponent, canDeactivate: [NavigationGuardService],
      children: [
        { path: 'dashboard', component: DashboardComponent },
        { path: 'todos', component: TodosComponent },
        { path: 'logbook', component: LogbookItemComponent, canDeactivate: [NavigationGuardService] },
