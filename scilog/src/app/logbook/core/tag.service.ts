...
export class TagService {
  ...
  constructor(private tagDataService: TagDataService, private logbookInfoService: LogbookInfoService) { }
  ...
  private addTag(tag: string){
    let tagStatEntry = this.tagStat.find(e=>{return e.name==tag});
    typeof tagStatEntry == 'undefined' ? this.tagStat.push({name: tag, count: 1}) : tagStatEntry.count += 1;
  }
