...
if TYPE_CHECKING:
  ...
  from ..models.job_include_filter_items import JobIncludeFilterItems
...
class JobFilter:
    ...
    Attributes:
        ...
        include (Union[Unset, List[Union['JobIncludeFilterItems', str]]]):
    """
    ...
    include: Union[Unset, List[Union['JobIncludeFilterItems', str]]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.include, Unset):
            ...
            for include_item_data in self.include:
                ...
                if isinstance(include_item_data, JobIncludeFilterItems):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for include_item_data in (_include or []):
            def _parse_include_item(data: object) -> Union['JobIncludeFilterItems', str]:
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    include_item_type_0 = JobIncludeFilterItems.from_dict(data)
                    ...
                    pass
                return cast(Union['JobIncludeFilterItems', str], data)
