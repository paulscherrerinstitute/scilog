...
T = TypeVar("T", bound="FilesnippetFilterFieldsType0")

@attr.s(auto_attribs=True)
class FilesnippetFilterFieldsType0:
    """
    Attributes:
        id (Union[Unset, bool]):
        ...
        file_extension (Union[Unset, bool]):
        content_type (Union[Unset, bool]):
        access_hash (Union[Unset, bool]):
        file_id (Union[Unset, bool]):
    """
    ...
    file_extension: Union[Unset, bool] = UNSET
    content_type: Union[Unset, bool] = UNSET
    access_hash: Union[Unset, bool] = UNSET
    file_id: Union[Unset, bool] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        filesnippet_filter_fields_type_0 = cls(
            id=id,
        ...
        filesnippet_filter_fields_type_0.additional_properties = d
        return filesnippet_filter_fields_type_0
