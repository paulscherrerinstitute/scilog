...
if TYPE_CHECKING:
  from ..models.view_filter_fields_type_0 import ViewFilterFieldsType0
  from ..models.view_include_filter_items import ViewIncludeFilterItems
...
class ViewFilter:
    ...
    Attributes:
        ...
        fields (Union['ViewFilterFieldsType0', List[str], Unset]):
        include (Union[Unset, List[Union['ViewIncludeFilterItems', str]]]):
    """
    ...
    fields: Union['ViewFilterFieldsType0', List[str], Unset] = UNSET
    include: Union[Unset, List[Union['ViewIncludeFilterItems', str]]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.fields, ViewFilterFieldsType0):
            fields = UNSET
        ...
        if not isinstance(self.include, Unset):
            ...
            for include_item_data in self.include:
                ...
                if isinstance(include_item_data, ViewIncludeFilterItems):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_fields(data: object) -> Union['ViewFilterFieldsType0', List[str], Unset]:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                _fields_type_0 = data
                fields_type_0: Union[Unset, ViewFilterFieldsType0]
                if isinstance(_fields_type_0,  Unset):
                    fields_type_0 = UNSET
                else:
                    fields_type_0 = ViewFilterFieldsType0.from_dict(_fields_type_0)
        ...
        for include_item_data in (_include or []):
            def _parse_include_item(data: object) -> Union['ViewIncludeFilterItems', str]:
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    include_item_type_0 = ViewIncludeFilterItems.from_dict(data)
                    ...
                    pass
                return cast(Union['ViewIncludeFilterItems', str], data)
