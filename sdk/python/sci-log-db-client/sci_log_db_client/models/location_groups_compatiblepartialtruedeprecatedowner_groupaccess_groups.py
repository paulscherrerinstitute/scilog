...
if TYPE_CHECKING:
  from ..models.location_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups_files import (
      LocationGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsFiles,
  )




T = TypeVar("T", bound="LocationGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class LocationGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroups:
    """(tsType: Partial<LocationGroupsCompatible>, schemaOptions: { partial: true, title:
'LocationGroupsCompatible{"partial":true,"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    Attributes:
        ...
        files (Union[Unset, LocationGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsFiles]): Information
    ...
    files: Union[Unset, 'LocationGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsFiles'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        files: Union[Unset, LocationGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsFiles]
        if isinstance(_files,  Unset):
            files = UNSET
        else:
            files = LocationGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsFiles.from_dict(_files)




        location_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups = cls(
        ...
        location_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups.additional_properties = d
        return location_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups
