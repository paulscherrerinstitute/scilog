...
T = TypeVar("T", bound="NewTasktitleNewTaskexcludeiddeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class NewTasktitleNewTaskexcludeiddeprecatedownerGroupaccessGroups:
    """(tsType: Omit<TaskGroupsCompatible, 'id'>, schemaOptions: { exclude: [ 'id' ], title:
'NewTask{"title":"NewTask","exclude":["id"],"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_tasktitle_new_taskexcludeiddeprecatedowner_groupaccess_groups = cls(
        ...
        new_tasktitle_new_taskexcludeiddeprecatedowner_groupaccess_groups.additional_properties = d
        return new_tasktitle_new_taskexcludeiddeprecatedowner_groupaccess_groups
