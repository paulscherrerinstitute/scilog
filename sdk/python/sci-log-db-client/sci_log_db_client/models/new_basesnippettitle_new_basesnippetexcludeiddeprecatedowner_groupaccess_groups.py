...
T = TypeVar("T", bound="NewBasesnippettitleNewBasesnippetexcludeiddeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class NewBasesnippettitleNewBasesnippetexcludeiddeprecatedownerGroupaccessGroups:
    """(tsType: Omit<BasesnippetGroupsCompatible, 'id'>, schemaOptions: { exclude: [ 'id' ], title:
'NewBasesnippet{"title":"NewBasesnippet","exclude":["id"],"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_basesnippettitle_new_basesnippetexcludeiddeprecatedowner_groupaccess_groups = cls(
        ...
        new_basesnippettitle_new_basesnippetexcludeiddeprecatedowner_groupaccess_groups.additional_properties = d
        return new_basesnippettitle_new_basesnippetexcludeiddeprecatedowner_groupaccess_groups
