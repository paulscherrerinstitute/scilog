...
T = TypeVar("T", bound="BasesnippetGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class BasesnippetGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroups:
    """(tsType: BasesnippetGroupsCompatibleWithRelations, schemaOptions: { includeRelations: true, title:
'BasesnippetGroupsCompatible{"includeRelations":true,"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        basesnippet_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups = cls(
        ...
        basesnippet_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups.additional_properties = d
        return basesnippet_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups
