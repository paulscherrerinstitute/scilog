...
if TYPE_CHECKING:
  from ..models.job_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups_params import (
      JobGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsParams,
  )




T = TypeVar("T", bound="JobGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class JobGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroups:
    """(tsType: Partial<JobGroupsCompatible>, schemaOptions: { partial: true, title:
'JobGroupsCompatible{"partial":true,"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    Attributes:
        ...
        params (Union[Unset, JobGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsParams]): Job parameters
    """
    ...
    params: Union[Unset, 'JobGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsParams'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        params: Union[Unset, JobGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsParams]
        if isinstance(_params,  Unset):
            params = UNSET
        else:
            params = JobGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsParams.from_dict(_params)




        job_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups = cls(
        ...
        job_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups.additional_properties = d
        return job_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups
