...
T = TypeVar("T", bound="BasesnippetGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class BasesnippetGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroups:
    """(tsType: Partial<BasesnippetGroupsCompatible>, schemaOptions: { partial: true, title:
'BasesnippetGroupsCompatible{"partial":true,"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        basesnippet_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups = cls(
        ...
        basesnippet_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups.additional_properties = d
        return basesnippet_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups
