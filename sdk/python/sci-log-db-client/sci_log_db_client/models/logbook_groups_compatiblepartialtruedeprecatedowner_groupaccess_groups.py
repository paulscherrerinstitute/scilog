...
T = TypeVar("T", bound="LogbookGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class LogbookGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroups:
    """(tsType: Partial<LogbookGroupsCompatible>, schemaOptions: { partial: true, title:
'LogbookGroupsCompatible{"partial":true,"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    Attributes:
        ...
        name (Union[Unset, str]): Name of logbook as presented to user in GUI
        ...
        location (Union[Unset, str]): A logbook is usually connected to a location, such as beamline or instrument
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        logbook_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups = cls(
        ...
        logbook_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups.additional_properties = d
        return logbook_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups
