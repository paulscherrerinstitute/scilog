...
from ..models.paragraph_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups_link_type import (
    ParagraphGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsLinkType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
  from ..models.paragraph_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups_files import (
      ParagraphGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsFiles,
  )




T = TypeVar("T", bound="ParagraphGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class ParagraphGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroups:
    """(tsType: Partial<ParagraphGroupsCompatible>, schemaOptions: { partial: true, title:
'ParagraphGroupsCompatible{"partial":true,"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    Attributes:
        ...
        link_type (Union[Unset, ParagraphGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsLinkType]): Defines
            if this entry is considered a comment (to be displayed near the parent info) or an entry which refers to
        ...
        files (Union[Unset, ParagraphGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsFiles]): Information
            about the embedded files.
    """
    ...
    link_type: Union[Unset, ParagraphGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsLinkType] = UNSET
    is_message: Union[Unset, bool] = UNSET
    files: Union[Unset, 'ParagraphGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsFiles'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        link_type: Union[Unset, ParagraphGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsLinkType]
        if isinstance(_link_type,  Unset):
            link_type = UNSET
        else:
            link_type = ParagraphGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsLinkType(_link_type)
        ...
        files: Union[Unset, ParagraphGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsFiles]
        if isinstance(_files,  Unset):
            files = UNSET
        else:
            files = ParagraphGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsFiles.from_dict(_files)




        paragraph_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups = cls(
        ...
        paragraph_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups.additional_properties = d
        return paragraph_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups
