...
T = TypeVar("T", bound="LogbookGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class LogbookGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroups:
    """(tsType: LogbookGroupsCompatibleWithRelations, schemaOptions: { includeRelations: true, title:
'LogbookGroupsCompatible{"includeRelations":true,"deprecated":["ownerGroup","accessGroups"]}' })

    Attributes:
        name (str): Name of logbook as presented to user in GUI
        location (str): A logbook is usually connected to a location, such as beamline or instrument
        ...
        description (Union[Unset, str]): Optional detailed definition of contents and purpose of this logbook
        thumbnail (Union[Unset, str]): Optional image/logo associated to this logbook
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        logbook_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups = cls(
            name=name,
            location=location,
        ...
        logbook_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups.additional_properties = d
        return logbook_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups
