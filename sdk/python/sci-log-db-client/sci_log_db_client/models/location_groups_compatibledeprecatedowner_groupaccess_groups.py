...
if TYPE_CHECKING:
  from ..models.location_groups_compatibledeprecatedowner_groupaccess_groups_files import (
      LocationGroupsCompatibledeprecatedownerGroupaccessGroupsFiles,
  )




T = TypeVar("T", bound="LocationGroupsCompatibledeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class LocationGroupsCompatibledeprecatedownerGroupaccessGroups:
    """(tsType: LocationGroupsCompatible, schemaOptions: { title:
'LocationGroupsCompatible{"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    Attributes:
        ...
        files (Union[Unset, LocationGroupsCompatibledeprecatedownerGroupaccessGroupsFiles]): Information about the
            embedded files.
    """
    ...
    files: Union[Unset, 'LocationGroupsCompatibledeprecatedownerGroupaccessGroupsFiles'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        files: Union[Unset, LocationGroupsCompatibledeprecatedownerGroupaccessGroupsFiles]
        if isinstance(_files,  Unset):
            files = UNSET
        else:
            files = LocationGroupsCompatibledeprecatedownerGroupaccessGroupsFiles.from_dict(_files)




        location_groups_compatibledeprecatedowner_groupaccess_groups = cls(
        ...
        location_groups_compatibledeprecatedowner_groupaccess_groups.additional_properties = d
        return location_groups_compatibledeprecatedowner_groupaccess_groups
