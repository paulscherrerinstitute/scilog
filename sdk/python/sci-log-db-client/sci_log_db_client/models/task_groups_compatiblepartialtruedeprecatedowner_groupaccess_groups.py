...
T = TypeVar("T", bound="TaskGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class TaskGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroups:
    """(tsType: Partial<TaskGroupsCompatible>, schemaOptions: { partial: true, title:
'TaskGroupsCompatible{"partial":true,"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        task_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups = cls(
        ...
        task_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups.additional_properties = d
        return task_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups
