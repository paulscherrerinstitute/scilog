...
if TYPE_CHECKING:
  from ..models.new_viewtitle_new_viewexcludeiddeprecatedowner_groupaccess_groups_configuration import (
      NewViewtitleNewViewexcludeiddeprecatedownerGroupaccessGroupsConfiguration,
  )




T = TypeVar("T", bound="NewViewtitleNewViewexcludeiddeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class NewViewtitleNewViewexcludeiddeprecatedownerGroupaccessGroups:
    """(tsType: Omit<ViewGroupsCompatible, 'id'>, schemaOptions: { exclude: [ 'id' ], title:
'NewView{"title":"NewView","exclude":["id"],"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    Attributes:
        ...
        configuration (NewViewtitleNewViewexcludeiddeprecatedownerGroupaccessGroupsConfiguration): JSON object defining
            the details of the view, e.g. which filter parameters to be used in navigation and which presentation types,
            like table, grid etc should be used.
    ...
    name: str
    configuration: 'NewViewtitleNewViewexcludeiddeprecatedownerGroupaccessGroupsConfiguration'
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        configuration = NewViewtitleNewViewexcludeiddeprecatedownerGroupaccessGroupsConfiguration.from_dict(d.pop("configuration"))
        ...
        new_viewtitle_new_viewexcludeiddeprecatedowner_groupaccess_groups = cls(
            name=name,
            configuration=configuration,
        ...
        new_viewtitle_new_viewexcludeiddeprecatedowner_groupaccess_groups.additional_properties = d
        return new_viewtitle_new_viewexcludeiddeprecatedowner_groupaccess_groups
