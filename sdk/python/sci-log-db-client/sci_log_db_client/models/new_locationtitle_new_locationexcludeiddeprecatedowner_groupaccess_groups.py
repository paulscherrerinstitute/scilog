...
if TYPE_CHECKING:
  from ..models.new_locationtitle_new_locationexcludeiddeprecatedowner_groupaccess_groups_files import (
      NewLocationtitleNewLocationexcludeiddeprecatedownerGroupaccessGroupsFiles,
  )




T = TypeVar("T", bound="NewLocationtitleNewLocationexcludeiddeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class NewLocationtitleNewLocationexcludeiddeprecatedownerGroupaccessGroups:
    """(tsType: Omit<LocationGroupsCompatible, 'id'>, schemaOptions: { exclude: [ 'id' ], title:
'NewLocation{"title":"NewLocation","exclude":["id"],"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    Attributes:
        ...
        files (Union[Unset, NewLocationtitleNewLocationexcludeiddeprecatedownerGroupaccessGroupsFiles]): Information
    ...
    files: Union[Unset, 'NewLocationtitleNewLocationexcludeiddeprecatedownerGroupaccessGroupsFiles'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        files: Union[Unset, NewLocationtitleNewLocationexcludeiddeprecatedownerGroupaccessGroupsFiles]
        if isinstance(_files,  Unset):
            files = UNSET
        else:
            files = NewLocationtitleNewLocationexcludeiddeprecatedownerGroupaccessGroupsFiles.from_dict(_files)




        new_locationtitle_new_locationexcludeiddeprecatedowner_groupaccess_groups = cls(
        ...
        new_locationtitle_new_locationexcludeiddeprecatedowner_groupaccess_groups.additional_properties = d
        return new_locationtitle_new_locationexcludeiddeprecatedowner_groupaccess_groups
