...
T = TypeVar("T", bound="FilesnippetGroupsCompatiblestricttruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class FilesnippetGroupsCompatiblestricttruedeprecatedownerGroupaccessGroups:
    """(tsType: FilesnippetGroupsCompatible, schemaOptions: { strict: true, title:
'FilesnippetGroupsCompatible{"strict":true,"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        filesnippet_groups_compatiblestricttruedeprecatedowner_groupaccess_groups = cls(
        ...
        return filesnippet_groups_compatiblestricttruedeprecatedowner_groupaccess_groups
