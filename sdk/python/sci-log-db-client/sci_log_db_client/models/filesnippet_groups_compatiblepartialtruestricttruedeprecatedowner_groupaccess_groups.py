...
T = TypeVar("T", bound="FilesnippetGroupsCompatiblepartialtruestricttruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class FilesnippetGroupsCompatiblepartialtruestricttruedeprecatedownerGroupaccessGroups:
    """(tsType: Partial<FilesnippetGroupsCompatible>, schemaOptions: { partial: true, strict: true, title:
'FilesnippetGroupsCompatible{"partial":true,"strict":true,"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        filesnippet_groups_compatiblepartialtruestricttruedeprecatedowner_groupaccess_groups = cls(
        ...
        return filesnippet_groups_compatiblepartialtruestricttruedeprecatedowner_groupaccess_groups
