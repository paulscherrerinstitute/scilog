...
T = TypeVar("T", bound="LocationFilterFieldsType0")

@attr.s(auto_attribs=True)
class LocationFilterFieldsType0:
    """
    Attributes:
        id (Union[Unset, bool]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        location_filter_fields_type_0 = cls(
            id=id,
        ...
        location_filter_fields_type_0.additional_properties = d
        return location_filter_fields_type_0
