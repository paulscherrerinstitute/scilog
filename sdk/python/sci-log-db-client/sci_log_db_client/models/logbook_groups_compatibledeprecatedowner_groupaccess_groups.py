...
T = TypeVar("T", bound="LogbookGroupsCompatibledeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class LogbookGroupsCompatibledeprecatedownerGroupaccessGroups:
    """(tsType: LogbookGroupsCompatible, schemaOptions: { title:
'LogbookGroupsCompatible{"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        logbook_groups_compatibledeprecatedowner_groupaccess_groups = cls(
            name=name,
            location=location,
        ...
        logbook_groups_compatibledeprecatedowner_groupaccess_groups.additional_properties = d
        return logbook_groups_compatibledeprecatedowner_groupaccess_groups
