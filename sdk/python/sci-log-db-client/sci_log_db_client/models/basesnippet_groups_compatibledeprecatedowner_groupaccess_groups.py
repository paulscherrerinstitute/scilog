...
T = TypeVar("T", bound="BasesnippetGroupsCompatibledeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class BasesnippetGroupsCompatibledeprecatedownerGroupaccessGroups:
    """(tsType: BasesnippetGroupsCompatible, schemaOptions: { title:
'BasesnippetGroupsCompatible{"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        basesnippet_groups_compatibledeprecatedowner_groupaccess_groups = cls(
        ...
        basesnippet_groups_compatibledeprecatedowner_groupaccess_groups.additional_properties = d
        return basesnippet_groups_compatibledeprecatedowner_groupaccess_groups
