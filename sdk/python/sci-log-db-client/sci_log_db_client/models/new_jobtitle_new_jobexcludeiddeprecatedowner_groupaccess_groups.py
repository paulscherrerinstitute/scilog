...
if TYPE_CHECKING:
  from ..models.new_jobtitle_new_jobexcludeiddeprecatedowner_groupaccess_groups_params import (
      NewJobtitleNewJobexcludeiddeprecatedownerGroupaccessGroupsParams,
  )




T = TypeVar("T", bound="NewJobtitleNewJobexcludeiddeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class NewJobtitleNewJobexcludeiddeprecatedownerGroupaccessGroups:
    """(tsType: Omit<JobGroupsCompatible, 'id'>, schemaOptions: { exclude: [ 'id' ], title:
'NewJob{"title":"NewJob","exclude":["id"],"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    Attributes:
        ...
        params (Union[Unset, NewJobtitleNewJobexcludeiddeprecatedownerGroupaccessGroupsParams]): Job parameters
    """
    ...
    params: Union[Unset, 'NewJobtitleNewJobexcludeiddeprecatedownerGroupaccessGroupsParams'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        params: Union[Unset, NewJobtitleNewJobexcludeiddeprecatedownerGroupaccessGroupsParams]
        if isinstance(_params,  Unset):
            params = UNSET
        else:
            params = NewJobtitleNewJobexcludeiddeprecatedownerGroupaccessGroupsParams.from_dict(_params)




        new_jobtitle_new_jobexcludeiddeprecatedowner_groupaccess_groups = cls(
        ...
        new_jobtitle_new_jobexcludeiddeprecatedowner_groupaccess_groups.additional_properties = d
        return new_jobtitle_new_jobexcludeiddeprecatedowner_groupaccess_groups
