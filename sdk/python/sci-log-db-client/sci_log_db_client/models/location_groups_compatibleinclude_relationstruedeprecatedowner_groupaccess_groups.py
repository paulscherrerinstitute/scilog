...
if TYPE_CHECKING:
  ...
  from ..models.location_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups_files import (
      LocationGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroupsFiles,
  )




T = TypeVar("T", bound="LocationGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class LocationGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroups:
    """(tsType: LocationGroupsCompatibleWithRelations, schemaOptions: { includeRelations: true, title:
'LocationGroupsCompatible{"includeRelations":true,"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    Attributes:
        ...
        name (Union[Unset, str]): Name of the location, e.g. X12SA
        location (Union[Unset, str]): Location string, e.g. /PSI/SLS/X12SA
        files (Union[Unset, LocationGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroupsFiles]):
    ...
    files: Union[Unset, 'LocationGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroupsFiles'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_files,  Unset):
            ...
            files = LocationGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroupsFiles.from_dict(_files)
        ...
        location_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups = cls(
        ...
        location_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups.additional_properties = d
        return location_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups
