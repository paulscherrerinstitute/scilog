...
T = TypeVar("T", bound="NewFiletitleNewFileexcludeidstricttruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class NewFiletitleNewFileexcludeidstricttruedeprecatedownerGroupaccessGroups:
    """(tsType: Omit<FilesnippetGroupsCompatible, 'id'>, schemaOptions: { exclude: [ 'id' ], strict: true, title:
'NewFile{"title":"NewFile","exclude":["id"],"strict":true,"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_filetitle_new_fileexcludeidstricttruedeprecatedowner_groupaccess_groups = cls(
        ...
        return new_filetitle_new_fileexcludeidstricttruedeprecatedowner_groupaccess_groups
