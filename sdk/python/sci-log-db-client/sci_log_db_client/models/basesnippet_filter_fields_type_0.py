...
T = TypeVar("T", bound="BasesnippetFilterFieldsType0")

@attr.s(auto_attribs=True)
class BasesnippetFilterFieldsType0:
    """
    Attributes:
        id (Union[Unset, bool]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        basesnippet_filter_fields_type_0 = cls(
            id=id,
        ...
        basesnippet_filter_fields_type_0.additional_properties = d
        return basesnippet_filter_fields_type_0
