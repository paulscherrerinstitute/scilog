...
T = TypeVar("T", bound="TaskFilterFieldsType0")

@attr.s(auto_attribs=True)
class TaskFilterFieldsType0:
    """
    Attributes:
        id (Union[Unset, bool]):
        ...
        content (Union[Unset, bool]):
        is_done (Union[Unset, bool]):
    """
    ...
    content: Union[Unset, bool] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        task_filter_fields_type_0.additional_properties = d
        return task_filter_fields_type_0
