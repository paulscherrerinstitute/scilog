...
T = TypeVar("T", bound="FilesnippetGroupsCompatibleincludeRelationstruestricttruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class FilesnippetGroupsCompatibleincludeRelationstruestricttruedeprecatedownerGroupaccessGroups:
    """(tsType: FilesnippetGroupsCompatibleWithRelations, schemaOptions: { includeRelations: true, strict: true, title:
'FilesnippetGroupsCompatible{"includeRelations":true,"strict":true,"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    Attributes:
        ...
        name (Union[Unset, str]): Optional name of file as presented to user in GUI
        description (Union[Unset, str]): Optional detailed definition of contents and purpose of this file
        filename (Union[Unset, str]): Name of the file
        file_extension (Union[Unset, str]): File extension of the file
        content_type (Union[Unset, str]): Content type of the file, e.g. image/jpeg
        access_hash (Union[Unset, str]): Access hash for directly accessing the resource.
        file_id (Union[Unset, str]): File id of the file
    ...
    access_hash: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if access_hash is not UNSET:
            field_dict["accessHash"] = access_hash
        if file_id is not UNSET:
            field_dict["_fileId"] = file_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        access_hash = d.pop("accessHash", UNSET)

        file_id = d.pop("_fileId", UNSET)
        ...
        filesnippet_groups_compatibleinclude_relationstruestricttruedeprecatedowner_groupaccess_groups = cls(
        ...
        return filesnippet_groups_compatibleinclude_relationstruestricttruedeprecatedowner_groupaccess_groups
