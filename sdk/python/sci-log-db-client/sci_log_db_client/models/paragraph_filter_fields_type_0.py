...
T = TypeVar("T", bound="ParagraphFilterFieldsType0")

@attr.s(auto_attribs=True)
class ParagraphFilterFieldsType0:
    """
    Attributes:
        id (Union[Unset, bool]):
        ...
        textcontent (Union[Unset, bool]):
        link_type (Union[Unset, bool]):
        is_message (Union[Unset, bool]):
    ...
    textcontent: Union[Unset, bool] = UNSET
    link_type: Union[Unset, bool] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        paragraph_filter_fields_type_0 = cls(
            id=id,
        ...
        paragraph_filter_fields_type_0.additional_properties = d
        return paragraph_filter_fields_type_0
