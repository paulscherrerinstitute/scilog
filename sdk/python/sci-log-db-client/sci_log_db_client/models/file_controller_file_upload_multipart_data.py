...
T = TypeVar("T", bound="FileControllerFileUploadMultipartData")

@attr.s(auto_attribs=True)
class FileControllerFileUploadMultipartData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        file_controller_file_upload_multipart_data = cls(
            fields=fields,
            file=file,
        )

        file_controller_file_upload_multipart_data.additional_properties = d
        return file_controller_file_upload_multipart_data
