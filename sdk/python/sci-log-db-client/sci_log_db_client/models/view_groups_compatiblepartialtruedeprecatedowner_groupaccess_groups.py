...
if TYPE_CHECKING:
  from ..models.view_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups_configuration import (
      ViewGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsConfiguration,
  )




T = TypeVar("T", bound="ViewGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class ViewGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroups:
    """(tsType: Partial<ViewGroupsCompatible>, schemaOptions: { partial: true, title:
'ViewGroupsCompatible{"partial":true,"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    Attributes:
        ...
        name (Union[Unset, str]): Unique name of view, presented to the user in the GUI for view selection
        ...
        configuration (Union[Unset, ViewGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsConfiguration]): JSON
    ...
    configuration: Union[Unset, 'ViewGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsConfiguration'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        configuration: Union[Unset, ViewGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsConfiguration]
        if isinstance(_configuration,  Unset):
            configuration = UNSET
        else:
            configuration = ViewGroupsCompatiblepartialtruedeprecatedownerGroupaccessGroupsConfiguration.from_dict(_configuration)




        view_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups = cls(
        ...
        view_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups.additional_properties = d
        return view_groups_compatiblepartialtruedeprecatedowner_groupaccess_groups
