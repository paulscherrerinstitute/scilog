...
if TYPE_CHECKING:
  ...
  from ..models.view_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups_configuration import (
      ViewGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroupsConfiguration,
  )




T = TypeVar("T", bound="ViewGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class ViewGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroups:
    """(tsType: ViewGroupsCompatibleWithRelations, schemaOptions: { includeRelations: true, title:
'ViewGroupsCompatible{"includeRelations":true,"deprecated":["ownerGroup","accessGroups"]}' })

    Attributes:
        name (str): Unique name of view, presented to the user in the GUI for view selection
        configuration (ViewGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroupsConfiguration): JSON
            object defining the details of the view, e.g. which filter parameters to be used in navigation and which
        ...
        description (Union[Unset, str]): Optional more detailed tooltip like description for this view
        location (Union[Unset, str]): Optional linking to a location to enable finding views dedicated to a certain
            location, beamline or instrumnet
    ...
    name: str
    configuration: 'ViewGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroupsConfiguration'
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        configuration = ViewGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroupsConfiguration.from_dict(d.pop("configuration"))
        ...
        view_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups = cls(
            name=name,
            configuration=configuration,
        ...
        view_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups.additional_properties = d
        return view_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups
