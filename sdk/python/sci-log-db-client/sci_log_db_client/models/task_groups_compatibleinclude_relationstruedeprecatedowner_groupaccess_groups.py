...
T = TypeVar("T", bound="TaskGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class TaskGroupsCompatibleincludeRelationstruedeprecatedownerGroupaccessGroups:
    """(tsType: TaskGroupsCompatibleWithRelations, schemaOptions: { includeRelations: true, title:
'TaskGroupsCompatible{"includeRelations":true,"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    Attributes:
        ...
        content (Union[Unset, str]): Description of the task
        is_done (Union[Unset, bool]): True if the task is done
    ...
    is_done: Union[Unset, bool] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        task_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups = cls(
        ...
        task_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups.additional_properties = d
        return task_groups_compatibleinclude_relationstruedeprecatedowner_groupaccess_groups
