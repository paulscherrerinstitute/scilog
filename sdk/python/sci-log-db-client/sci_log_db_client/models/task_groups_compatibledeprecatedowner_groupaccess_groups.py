...
T = TypeVar("T", bound="TaskGroupsCompatibledeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class TaskGroupsCompatibledeprecatedownerGroupaccessGroups:
    """(tsType: TaskGroupsCompatible, schemaOptions: { title:
'TaskGroupsCompatible{"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        task_groups_compatibledeprecatedowner_groupaccess_groups = cls(
        ...
        task_groups_compatibledeprecatedowner_groupaccess_groups.additional_properties = d
        return task_groups_compatibledeprecatedowner_groupaccess_groups
