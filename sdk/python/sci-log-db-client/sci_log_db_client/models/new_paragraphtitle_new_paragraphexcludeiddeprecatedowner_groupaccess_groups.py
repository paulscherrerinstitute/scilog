...
from ..models.new_paragraphtitle_new_paragraphexcludeiddeprecatedowner_groupaccess_groups_link_type import (
    NewParagraphtitleNewParagraphexcludeiddeprecatedownerGroupaccessGroupsLinkType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
  from ..models.new_paragraphtitle_new_paragraphexcludeiddeprecatedowner_groupaccess_groups_files import (
      NewParagraphtitleNewParagraphexcludeiddeprecatedownerGroupaccessGroupsFiles,
  )




T = TypeVar("T", bound="NewParagraphtitleNewParagraphexcludeiddeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class NewParagraphtitleNewParagraphexcludeiddeprecatedownerGroupaccessGroups:
    """(tsType: Omit<ParagraphGroupsCompatible, 'id'>, schemaOptions: { exclude: [ 'id' ], title:
'NewParagraph{"title":"NewParagraph","exclude":["id"],"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    Attributes:
        ...
        link_type (Union[Unset, NewParagraphtitleNewParagraphexcludeiddeprecatedownerGroupaccessGroupsLinkType]):
        ...
        files (Union[Unset, NewParagraphtitleNewParagraphexcludeiddeprecatedownerGroupaccessGroupsFiles]): Information
    ...
    link_type: Union[Unset, NewParagraphtitleNewParagraphexcludeiddeprecatedownerGroupaccessGroupsLinkType] = UNSET
    is_message: Union[Unset, bool] = UNSET
    files: Union[Unset, 'NewParagraphtitleNewParagraphexcludeiddeprecatedownerGroupaccessGroupsFiles'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_link_type,  Unset):
            ...
            link_type = NewParagraphtitleNewParagraphexcludeiddeprecatedownerGroupaccessGroupsLinkType(_link_type)
        ...
        files: Union[Unset, NewParagraphtitleNewParagraphexcludeiddeprecatedownerGroupaccessGroupsFiles]
        if isinstance(_files,  Unset):
            files = UNSET
        else:
            files = NewParagraphtitleNewParagraphexcludeiddeprecatedownerGroupaccessGroupsFiles.from_dict(_files)




        new_paragraphtitle_new_paragraphexcludeiddeprecatedowner_groupaccess_groups = cls(
        ...
        new_paragraphtitle_new_paragraphexcludeiddeprecatedowner_groupaccess_groups.additional_properties = d
        return new_paragraphtitle_new_paragraphexcludeiddeprecatedowner_groupaccess_groups
