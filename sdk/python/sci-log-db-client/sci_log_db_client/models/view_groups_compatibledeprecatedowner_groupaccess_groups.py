...
if TYPE_CHECKING:
  from ..models.view_groups_compatibledeprecatedowner_groupaccess_groups_configuration import (
      ViewGroupsCompatibledeprecatedownerGroupaccessGroupsConfiguration,
  )




T = TypeVar("T", bound="ViewGroupsCompatibledeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class ViewGroupsCompatibledeprecatedownerGroupaccessGroups:
    """(tsType: ViewGroupsCompatible, schemaOptions: { title:
'ViewGroupsCompatible{"deprecated":["ownerGroup","accessGroups"]}' })

    Attributes:
        name (str): Unique name of view, presented to the user in the GUI for view selection
        configuration (ViewGroupsCompatibledeprecatedownerGroupaccessGroupsConfiguration): JSON object defining the
            details of the view, e.g. which filter parameters to be used in navigation and which presentation types, like
            table, grid etc should be used.
    ...
    name: str
    configuration: 'ViewGroupsCompatibledeprecatedownerGroupaccessGroupsConfiguration'
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        configuration = ViewGroupsCompatibledeprecatedownerGroupaccessGroupsConfiguration.from_dict(d.pop("configuration"))
        ...
        view_groups_compatibledeprecatedowner_groupaccess_groups = cls(
            name=name,
            configuration=configuration,
        ...
        view_groups_compatibledeprecatedowner_groupaccess_groups.additional_properties = d
        return view_groups_compatibledeprecatedowner_groupaccess_groups
