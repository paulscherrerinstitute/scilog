...
T = TypeVar("T", bound="LogbookFilterFieldsType0")

@attr.s(auto_attribs=True)
class LogbookFilterFieldsType0:
    """
    Attributes:
        id (Union[Unset, bool]):
        ...
        thumbnail (Union[Unset, bool]):
        location (Union[Unset, bool]):
    """
    ...
    thumbnail: Union[Unset, bool] = UNSET
    location: Union[Unset, bool] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        logbook_filter_fields_type_0 = cls(
            id=id,
        ...
        logbook_filter_fields_type_0.additional_properties = d
        return logbook_filter_fields_type_0
