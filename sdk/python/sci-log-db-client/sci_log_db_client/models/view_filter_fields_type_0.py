...
T = TypeVar("T", bound="ViewFilterFieldsType0")

@attr.s(auto_attribs=True)
class ViewFilterFieldsType0:
    """
    Attributes:
        id (Union[Unset, bool]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        view_filter_fields_type_0.additional_properties = d
        return view_filter_fields_type_0
