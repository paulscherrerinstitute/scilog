...
T = TypeVar("T", bound="BasesnippetWithRelations")

@attr.s(auto_attribs=True)
class BasesnippetWithRelations:
    """(tsType: BasesnippetWithRelations, schemaOptions: { includeRelations: true })
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        basesnippet_with_relations = cls(
            id=id,
        ...
        basesnippet_with_relations.additional_properties = d
        return basesnippet_with_relations
