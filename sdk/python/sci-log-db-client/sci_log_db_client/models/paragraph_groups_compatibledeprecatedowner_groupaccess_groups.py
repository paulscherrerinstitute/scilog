...
from ..models.paragraph_groups_compatibledeprecatedowner_groupaccess_groups_link_type import (
    ParagraphGroupsCompatibledeprecatedownerGroupaccessGroupsLinkType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
  from ..models.paragraph_groups_compatibledeprecatedowner_groupaccess_groups_files import (
      ParagraphGroupsCompatibledeprecatedownerGroupaccessGroupsFiles,
  )




T = TypeVar("T", bound="ParagraphGroupsCompatibledeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class ParagraphGroupsCompatibledeprecatedownerGroupaccessGroups:
    """(tsType: ParagraphGroupsCompatible, schemaOptions: { title:
'ParagraphGroupsCompatible{"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    Attributes:
        ...
        link_type (Union[Unset, ParagraphGroupsCompatibledeprecatedownerGroupaccessGroupsLinkType]): Defines if this
            entry is considered a comment (to be displayed near the parent info) or an entry which refers to previous
            discussion entries in which case the entry is shown in chronological order and the parent entry is partially
            duplicated as a quote
        is_message (Union[Unset, bool]): Defines if this entry is considered a message.
        files (Union[Unset, ParagraphGroupsCompatibledeprecatedownerGroupaccessGroupsFiles]): Information about the
            embedded files.
    """
    ...
    link_type: Union[Unset, ParagraphGroupsCompatibledeprecatedownerGroupaccessGroupsLinkType] = UNSET
    is_message: Union[Unset, bool] = UNSET
    files: Union[Unset, 'ParagraphGroupsCompatibledeprecatedownerGroupaccessGroupsFiles'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        link_type: Union[Unset, ParagraphGroupsCompatibledeprecatedownerGroupaccessGroupsLinkType]
        if isinstance(_link_type,  Unset):
            link_type = UNSET
        else:
            link_type = ParagraphGroupsCompatibledeprecatedownerGroupaccessGroupsLinkType(_link_type)
        ...
        files: Union[Unset, ParagraphGroupsCompatibledeprecatedownerGroupaccessGroupsFiles]
        if isinstance(_files,  Unset):
            files = UNSET
        else:
            files = ParagraphGroupsCompatibledeprecatedownerGroupaccessGroupsFiles.from_dict(_files)




        paragraph_groups_compatibledeprecatedowner_groupaccess_groups = cls(
        ...
        paragraph_groups_compatibledeprecatedowner_groupaccess_groups.additional_properties = d
        return paragraph_groups_compatibledeprecatedowner_groupaccess_groups
