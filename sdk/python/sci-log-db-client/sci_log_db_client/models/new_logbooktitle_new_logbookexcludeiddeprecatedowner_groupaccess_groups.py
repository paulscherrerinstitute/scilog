...
T = TypeVar("T", bound="NewLogbooktitleNewLogbookexcludeiddeprecatedownerGroupaccessGroups")

@attr.s(auto_attribs=True)
class NewLogbooktitleNewLogbookexcludeiddeprecatedownerGroupaccessGroups:
    """(tsType: Omit<LogbookGroupsCompatible, 'id'>, schemaOptions: { exclude: [ 'id' ], title:
'NewLogbook{"title":"NewLogbook","exclude":["id"],"deprecated":["ownerGroup","accessGroups"]}' })
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_logbooktitle_new_logbookexcludeiddeprecatedowner_groupaccess_groups = cls(
            name=name,
            location=location,
        ...
        new_logbooktitle_new_logbookexcludeiddeprecatedowner_groupaccess_groups.additional_properties = d
        return new_logbooktitle_new_logbookexcludeiddeprecatedowner_groupaccess_groups
