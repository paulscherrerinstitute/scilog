...
from ...models.user_preference_partial import UserPreferencePartial
...
def _get_kwargs(
    *,
    ...
    json_body: UserPreferencePartial,
...
def sync_detailed(
    *,
    ...
    """
    Args:
        json_body (UserPreferencePartial): (tsType: Partial<UserPreference>, schemaOptions: {
            partial: true })
