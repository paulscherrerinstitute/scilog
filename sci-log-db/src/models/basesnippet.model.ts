...
export class Basesnippet extends Entity {
  ...
  @property({
    ...
    default: false,
    description:
      'Private snippets are meant not to be exported, e.g. as metadata to the data catalog. Often used for chat like communication',
  })
  isPrivate: boolean;
  ...
  @property({
    ...
    index: true,
    description:
      'Default display order is given by createdAt Time in ms*1000. Override to allow to place snippet between existing other snippets created in the past',
  })
  defaultOrder: number;
